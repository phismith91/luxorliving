...
- Update CHANGELOG when user-facing changes occur; add release notes stub if
  needed.
- Refresh diagnostics/services documentation when schemas change.

## Workflow

- Identify source-of-truth: code diffs, pyproject/requirements, scripts,
  services schemas.
- Propose doc changes concisely; keep instructions reproducible; include
  commands (pytest, black, isort).
