...
Release date: 7 January 2026 Status: BETA (testing welcome)

---

## Quality Scale – Silver achieved

This beta implements all critical features for Home Assistant Silver compliance,
based on the official Quality Scale guidelines.
...
- Performance test fix: `test_integration_entity_creation_benchmark` no longer
  requires a `hass` fixture
