...
[![Tests: 789](https://img.shields.io/badge/Tests-789%20passing-brightgreen.svg)](https://github.com/phismith91/luxorliving/blob/main/docs/TESTS.md)
...
<!-- RELEASE_NOTES_START -->
**Current release:** [v1.1.11](https://github.com/phismith91/luxorliving/releases/tag/v1.1.11) — Complete IP1 bus-freeze fix: proactive 6 h session refresh + blocking I/O fix
<!-- RELEASE_NOTES_END -->
