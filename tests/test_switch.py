...
class TestLuxorLivingSwitch:
    ...
    def test_init(self, mock_coordinator, mock_config_entry, mock_mapped_entity, mock_knx_gateway):
        ...
        switch = LuxorLivingSwitch(mock_coordinator, mock_config_entry, mock_mapped_entity, mock_knx_gateway)
    ...
    def test_handle_knx_update_off(self, mock_coordinator, mock_config_entry, mock_mapped_entity, mock_knx_gateway):
    ...
    def test_handle_knx_update_wrong_address(self, mock_coordinator, mock_config_entry, mock_mapped_entity, mock_knx_gateway):
